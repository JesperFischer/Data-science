...
b0a = -2    #intercept learning rate 
b1a = 0.5     #percept influence on learning rate
b0p = -1      #intercept percept
b1p = -0.3    #expectation effect on perception
b2p = 1.3     #stimulus effect on perception
kappa = 20    #precision on perception
